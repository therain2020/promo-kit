...
cta-card: {PROJECT}, {STAR_COUNT}, {TAGLINE}, {CTA_TEXT}, {FEATURES}, {URL}
...
# 设置视口
# 小红书: $B goto file:///... → 750×1000 → $B screenshot
# 小黑盒: $B goto file:///... → 750×1000 or 1200×800 → $B screenshot
```

每张图依次：`$B goto` 渲染后的 HTML → `$B screenshot {output_dir}/NN-name.png`
